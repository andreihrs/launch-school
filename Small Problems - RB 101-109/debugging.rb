...
#   name = name.chars.each { |c| c.upcase! }.join #name.upcase!
...
#     reversed_words.unshift(words[i])  # reversed_words = [words[i]] + reversed_words
#     i += 1
#   end
...
def idf(term, documents)
  ...
  number_of_documents_with_term = documents.count do |d|
    tf(term, d) > 0 
  end
